		...
		var template = '<aside ng-init="init()" class="main-sidebar fg-color">' +
							'<div class="row">'+
								'<div ng-if="channel" class="sidebar-channel col-xs-12">'+
	 							...
	 							'</div>' +
	 							'<div ng-if="view === \'main\'" class="sidebar-channels-menu col-xs-12">' +
									'<h2>Newest Channels</h2>' +
									'<ul class="col-xs-12 main-section-sidebar-menu">' +
										...
										'<li><hr/><a class="btn" href="/{{page.site_info.address}}/index.html?view:channels">All Channels</a></li>' +
									'</ul> ' +
								'</div>'
